...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: 'About Stride Run Club',
    description:
      "From three runners to a club that runs every week. What Stride is, how a run works, and who organises it.",
    images: [{ url: DEFAULT_OG_IMAGE, width: OG_IMAGE_WIDTH, height: OG_IMAGE_HEIGHT, alt: 'Stride Run Club Bengaluru' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'About Stride Run Club',
    description: 'From three runners to a club that runs every week in Bengaluru.',
...
const jsonLd = graph([
  {
    ...
    description:
      "Stride Run Club is Bengaluru's running community. 5,754 runners in 2025 across 97 community runs, and 63% of them were first-timers.",
    inLanguage: 'en-IN',
    ...
    <main className='min-h-screen'>
      ...
      <section className='px-6 pt-28 pb-12 md:pb-16 max-w-4xl mx-auto'>
        ...
        <p className='text-copy-white/70 text-lg md:text-xl leading-relaxed'>
          ...
          meeting to run. It now puts on two to three runs a week, every week, from
          beginner-friendly 5Ks to hill repeats, interval sessions and long runs. At peak,
          more than 300 people have turned up for a single Stride run.
        </p>
      </section>
      ...
      <section className='px-6 py-10 max-w-3xl mx-auto'>
        ...
        <p className='text-copy-white/70 text-lg leading-relaxed mb-5'>
          It means nobody gets dropped. Stride is deliberately not a race team. Of the people
          who ran with us in 2025, 63% had never run with a club before, and every run is
        ...
        <p className='text-copy-white/70 text-lg leading-relaxed'>
          ...
          mixer, with guided warm-ups from certified trainers, icebreakers, and coffee or
      ...
      <section className='px-6 py-10 pb-20 max-w-3xl mx-auto'>
        ...
        <p className='text-copy-white/70 text-lg leading-relaxed mb-5'>
          Sidharth Yadav founded Stride Run Club. What started as his weekend run is now
          organised by a team of more than ten leads, the people who plot the routes, set the
          pace and are at the start line before anyone else. {LEAD_STRIDERS.length} of them are
          profiled on the team page.
        </p>
        <p className='text-copy-white/70 text-lg leading-relaxed mb-5'>
          Stride Run Club is based in Bengaluru, Karnataka, India, and every run happens in the
          city.
        </p>
