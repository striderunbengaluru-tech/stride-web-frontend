...
export const metadata: Metadata = {
  ...
  description:
    'Meet the four Lead Striders who run Stride Run Club Bengaluru — the founders, pacers, run captains and organisers behind every group run, training block and race day.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'The four Lead Striders who set the pace, plan the routes and make race morning happen in Bengaluru.',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'Lead Striders — The Team Behind Stride Run Club',
    description:
      'The four Lead Striders who set the pace, plan the routes and make race morning happen.',
