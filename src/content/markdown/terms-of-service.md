...
"Content" refers to any text, images, videos, audio, posts, comments, or other material that appears on or through our Services.
"User Content" refers to any Content that users submit, upload, or transmit to or through our Services.
"Community Guidelines" refers to the additional rules and standards for participating in our community, which are incorporated by reference into these Terms.
...
## 7. Community Conduct
Our community is built on respect, constructive dialogue, and shared interests. When using our Services, you agree to follow our Community Guidelines, which include but are not limited to:

- Treating others with respect and courtesy
- Contributing constructively to discussions
- Not engaging in harassment, hate speech, or intimidation
- Not posting illegal, harmful, or inappropriate content
- Not spamming, flooding, or disrupting conversations
- Not impersonating others or misrepresenting your identity or affiliations
- Respecting the privacy of other users

Moderators and administrators have broad discretion to enforce these guidelines, including removing content, issuing warnings, temporarily suspending accounts, or permanently banning users.
...
You represent and warrant that you have all necessary rights to grant us this license and that your User Content does not violate any third-party rights, applicable laws, or our Community Guidelines.

You acknowledge that all User Content is public or semi-public and that others may view, save, or share your User Content. If you do not want certain information shared, do not post it to our Services.

We reserve the right to remove any User Content at our discretion, particularly content that violates these Terms or our Community Guidelines.

## 9. Content Moderation
We employ various moderation methods to maintain a safe and welcoming community, including automated filters, human moderators, and user reporting systems. Moderation decisions are made at our discretion but generally align with our Community Guidelines.

You agree to respect moderation decisions, even if you disagree with them. If you believe a moderation action was taken in error, you may appeal through designated channels, but we reserve the final decision in all moderation matters.

We do not have an obligation to monitor all User Content, and our moderation efforts should not be considered comprehensive. The responsibility for appropriate content remains with the users who post it.

## 10. User Reporting and Feedback
You are encouraged to report content or behavior that violates our Terms or Community Guidelines using the reporting tools provided in our Services. We review reports and take action as appropriate, but we do not guarantee a specific response time or particular outcome.

You may also provide feedback on our Services, including suggestions for improvement. By submitting feedback, you grant us an unrestricted, perpetual, irrevocable, non-exclusive, royalty-free license to use and implement your feedback in any way without any obligation to compensate you.

## 11. Private Communications
Our Services may include features that allow private communications between users, such as direct messaging. While these communications are not publicly visible, we may access and review them if:
- Required by law or legal process
- Necessary to enforce our Terms or Community Guidelines
- Needed to protect the safety, rights, or property of our users, the public, or Stride Run Club Bengaluru

You should not have an expectation of complete privacy for communications sent through our Services, and you should not use our Services to transmit sensitive or confidential information.

## 12. Prohibited Conduct
In addition to the requirements in our Community Guidelines, you agree not to:
...
- Create multiple accounts to evade moderation or restrictions
- Sell, trade, or transfer your account to another person
- Use our Services for unauthorized commercial purposes, including spamming
- Engage in vote manipulation or other actions to artificially inflate or decrease content visibility
...
- You authorize us to charge your payment method for renewals
- Subscription terms, pricing, and features may change with notice
- Refunds are provided only as specified in our refund policy

Different subscription tiers may offer different features, access levels, or benefits. We reserve the right to change subscription offerings at any time.

## 18. Disclaimer of Warranties
OUR SERVICES ARE PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, AND NON-INFRINGEMENT. Stride Run Club Bengaluru DOES NOT WARRANT THAT OUR SERVICES ARE ACCURATE, COMPLETE, RELIABLE, CURRENT, OR ERROR-FREE, THAT DEFECTS WILL BE CORRECTED, OR THAT OUR SERVICES OR THE SERVERS THAT MAKE OUR SERVICES AVAILABLE ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS.
...
- Have no real-world value and cannot be exchanged for real money or items of value
- May be modified, revoked, or made unavailable at any time at our discretion
...
### Appeals Process
If you believe your content was removed in error, you may appeal the moderation decision by contacting us at [contact us](https://www.strideclub.in/contact-us/). Please include the following information in your appeal:
...
We will review your appeal and respond within 2-3 business days. All moderation decisions following an appeal are final.
