const BLOGS = 'https://ienotcjldormdxrzukpk.supabase.co/storage/v1/object/public/stride-assets/images/blogs'

export const stridePokemonGoRunContent = `
Saturday, 23 May. Starbucks. A bunch of athletes who had no idea they were about to download a game, run through Cubbon Park chasing virtual eggs, and walk away with free coffee and (maybe) a Pikachu plushie.
...
Post-brief, everyone headed to Cubbon Park to do the actual run. Two groups split off based on their egg: 2km athletes and 5km athletes. Off they went.
...
For more runs like this, follow [Stride Run Club on Instagram](https://www.instagram.com/stride_runclub_bengaluru/). That is where all the good stuff drops first.
`
