  ...
  return (
    ...
    >
      <Link
        ...
        className='inline-flex items-center justify-center rounded-md bg-stride-yellow-accent px-8 py-3 min-h-11 text-copy-black font-bold text-base md:text-lg hover:scale-[1.03] active:scale-[0.97] transition-transform duration-150'
      >
        Become a Member
      </Link>
    </div>
